...
Plugin.prototype = {
    init: function() {
        ...
        this.selectedFlag.on('click', function(e) {
        ...
        this.countryListItems.on( "mouseover", function() {
            that._highlightListItem($(this));
        });
        // listen for country selection
        this.countryListItems.on('click', function(e) {
    ...
    _initAutoHideDialCode: function() {
        ...
        this.telInput.on("focusin", function() {
            var value = String.prototype.trim(that.telInput.val());
            if (value.length === 0) {
        ...
        this.telInput.on("focusout", function() {
            var value = String.prototype.trim(that.telInput.val());
            if (value.length > 0) {
                if (String.prototype.trim(that._getDialCode(value) + that.options.dcDelimiter) == value) {
                    that.telInput.val("");
                }
            }
        });
    ...
    _updateNumber: function(newDialCode) {
        ...
        if (prevDialCode.length > 1) {
            ...
            newNumber = newDialCode + this.options.dcDelimiter + String.prototype.trim(inputVal);
        } else {
    ...
    _getDialCode: function(inputVal) {
        var dialCode = "";
        inputVal = String.prototype.trim(inputVal);
