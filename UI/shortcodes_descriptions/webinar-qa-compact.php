...
if (!empty($is_list)) {
    ?><hr><p>
    <?php echo __('Q&A form without any headings', 'webinarignition'); ?>
    </p><?php
} else {
    ?><?php
}
...
<p class="code-example">
    <span class="code-example-value">[wi_webinar_block id="<?php echo $webinarId ?>" block="webinar_qa_compact"]</span><!--
