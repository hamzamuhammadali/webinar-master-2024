...
if (!empty($is_list)) {
    ?><p>
    <?php echo __('Webinar Sidebar Only', 'webinarignition'); ?>
    </p><?php
} else {
    ?><?php
}
...
<p class="code-example">
    <span class="code-example-value">[wi_webinar_block id="<?php echo $webinarId ?>" block="webinar_video_cta_sidebar"]</span><!--
