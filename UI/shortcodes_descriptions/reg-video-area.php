...
if (!empty($is_list)) {
    ?><hr><p>
        <?php echo __('CTA Area - Video / Image Settings', 'webinarignition'); ?>
    </p><?php
} else {
    ?><?php
}
...
<p class="code-example">
    <span class="code-example-value">[wi_webinar_block id="<?php echo $webinarId ?>" block="reg_video_area"]</span><!--
